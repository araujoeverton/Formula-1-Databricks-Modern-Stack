...
.json(f"{bronze_folder_path}/{v_file_date}/drivers.json")
...
drivers_final_df.write.mode("overwrite").format("delta").saveAsTable("silver.drivers")

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM silver.drivers
